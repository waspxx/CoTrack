...
4. **Commit automatico**: Se esegui il commit automatico il formato del messaggio dev'essere: `[NOME TAB] - <breve descrizione della modifica in inglese>`. Se non vuoi eseguire il commit automatico, puoi saltare questo passaggio.
